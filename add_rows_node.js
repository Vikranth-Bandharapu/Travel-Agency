...
let d_content = normalizeNewlines(fs.readFileSync('dashboard.html', 'utf8'));

const d_search1 = `                                  <td>Magical Venice & Rome</td>
...
const d_search2 = `                                  <td>INV-2026-089</td>
                                  <td>Sep 12, 2026</td>
                                  <td>$5,100</td>
...
const d_search3 = `                              <img src="assets/opt_img_10.webp" style="width: 100%; height: 120px; object-fit: cover; display: block;">
...
fs.writeFileSync('dashboard.html', d_content);

let a_content = normalizeNewlines(fs.readFileSync('agent_dashboard.html', 'utf8'));

const a_search1 = `                                  <td>#A-9082</td>
                                  <td>Sarah Jenkins</td>
                                  <td>Kyoto Temples</td>
...
const a_search2 = `                                  <td>Magical Venice & Rome</td>
                                  <td>18 / 20</td>
...
const a_search3 = `                                  <td>Oct 01, 2026</td>
                                  <td>$12,400.00</td>
                                  <td>**** **** 5678</td>
...
fs.writeFileSync('agent_dashboard.html', a_content);

console.log("Rows injected successfully!");
